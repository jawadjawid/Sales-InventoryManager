...
public class InitialEmployeeSignupController extends SignupController implements
  ...
  public void onClick(View v) {
    ...
    try {
      ...
      Toast.makeText(view, "Please ensure that all fields are completed.", Toast.LENGTH_SHORT)
          .show();
      e.printStackTrace();
    }
  }
