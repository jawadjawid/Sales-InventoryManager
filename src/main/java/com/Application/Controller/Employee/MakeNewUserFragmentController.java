...
public class MakeNewUserFragmentController extends SignupController implements
  ...
  public void onClick(View v) {
    ...
    try {
      ...
      Toast.makeText(appContext,
          "Please ensure that all fields are completed & length of address is less than 100 characters.",
