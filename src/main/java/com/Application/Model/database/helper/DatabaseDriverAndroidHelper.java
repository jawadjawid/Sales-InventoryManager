...
public class DatabaseDriverAndroidHelper extends DatabaseDriverAndroid {
  ...
  public DatabaseDriverAndroidHelper(Context context, String database_name) {
  ...
  public List<User> getUsersDetailsH() {
    ...
    while (results.moveToNext()) {
      ...
      user = createUser(results.getInt(results.getColumnIndex("ID")),
  ...
  public List<Item> getAllItemsH() {
    ...
    Item item;
    while (results.moveToNext()) {
      item = new ItemImpl(results.getInt(results.getColumnIndex("ID")),
          results.getString(results.getColumnIndex("NAME")),
  ...
  public Sale getSaleByIdH(int saleId) {
    ...
    while (results.moveToNext()) {
      ...
      sale = new SaleImpl(results.getInt(results.getColumnIndex("ID")), user,
          new BigDecimal(results.getString(results.getColumnIndex("TOTALPRICE"))));
    }
    results.close();
    return sale;
  ...
  public List<Sale> getSalesToUserH(int userId) {
    ...
    while (results.moveToNext()) {
      User user = getUserDetailsH(results.getInt(results.getColumnIndex("USERID")));
      sales.add(new SaleImpl(results.getInt(results.getColumnIndex("ID")), user,
          new BigDecimal(results.getString(results.getColumnIndex("TOTALPRICE")))));
    }
    results.close();
    return sales;
  ...
  public SalesLog getItemizedSalesH() {
    ...
    while (results.moveToNext()) {
      ...
      if (sale == null) {
        ...
        itemMap.put(getItemH(results.getInt(results.getColumnIndex("ITEMID"))),
            results.getInt(results.getColumnIndex("QUANTITY")));
        salesLog.addSale(
            new ItemizedSaleImpl(results.getInt(results.getColumnIndex("SALEID")), itemMap));
      } else {
    ...
    while (results.moveToNext()) {
      ...
      while (accountDetailsResult.moveToNext()) {
        currentAccount.addItem(
            getItemH(accountDetailsResult.getInt(accountDetailsResult.getColumnIndex("ITEMID"))),
