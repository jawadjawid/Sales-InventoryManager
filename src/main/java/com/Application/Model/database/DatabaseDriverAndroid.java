...
public class DatabaseDriverAndroid extends SQLiteOpenHelper {
    ...
    protected long insertNewUser(String name, int age, String address, String password, BigDecimal balance) {
        long id = insertUser(name, age, address,balance);
    ...
    protected long insertNewUserNoPassword(String name, int age, String address, BigDecimal balance) {
        return insertUser(name, age, address, balance);
    }
    ...
    private long insertUser(String name, int age, String address, BigDecimal balance) {
        SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put("NAME", name);
    ...
    protected boolean updateUserBalance(BigDecimal balance, int id) {
        SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put("BALANCE", balance.toPlainString());
        boolean result = sqLiteDatabase.update("USERS", contentValues, "ID = ?",
